...
interface ListProductsPageParams {}

interface ListProductsPageSearchParams {
  search?: string
  category_id?: string
}

interface ListProductsPageProps extends PageProps<ListProductsPageParams, ListProductsPageSearchParams> {}

async function getProducts({ search, category_id }: ListProductsPageSearchParams): Promise<Product[]> {
...
async function ListProductsPage({ searchParams }: ListProductsPageProps) {
